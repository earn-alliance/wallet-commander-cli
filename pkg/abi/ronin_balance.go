...
// RoninBalanceABI is the input ABI used to generate the binding from.
// Deprecated: Use RoninBalanceMetaData.ABI instead.
...
// RoninBalanceSession is an auto generated Go binding around an Ethereum contract,
...
// RoninBalanceCallerSession is an auto generated read-only Go binding around an Ethereum contract,
...
// RoninBalanceTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
...
func NewRoninBalance(address common.Address, backend bind.ContractBackend) (*RoninBalance, error) {
	contract, err := bindRoninBalance(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &RoninBalance{RoninBalanceCaller: RoninBalanceCaller{contract: contract}, RoninBalanceTransactor: RoninBalanceTransactor{contract: contract}, RoninBalanceFilterer: RoninBalanceFilterer{contract: contract}}, nil
}
...
func NewRoninBalanceCaller(address common.Address, caller bind.ContractCaller) (*RoninBalanceCaller, error) {
	contract, err := bindRoninBalance(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &RoninBalanceCaller{contract: contract}, nil
}
...
func NewRoninBalanceTransactor(address common.Address, transactor bind.ContractTransactor) (*RoninBalanceTransactor, error) {
	contract, err := bindRoninBalance(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &RoninBalanceTransactor{contract: contract}, nil
}
...
func NewRoninBalanceFilterer(address common.Address, filterer bind.ContractFilterer) (*RoninBalanceFilterer, error) {
	contract, err := bindRoninBalance(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &RoninBalanceFilterer{contract: contract}, nil
}

// bindRoninBalance binds a generic wrapper to an already deployed contract.
func bindRoninBalance(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(RoninBalanceABI))
	if err != nil {
		return nil, err
	}
...
func (_RoninBalance *RoninBalanceRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _RoninBalance.Contract.RoninBalanceCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_RoninBalance *RoninBalanceRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _RoninBalance.Contract.RoninBalanceTransactor.contract.Transfer(opts)
}
...
func (_RoninBalance *RoninBalanceRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _RoninBalance.Contract.RoninBalanceTransactor.contract.Transact(opts, method, params...)
}
...
func (_RoninBalance *RoninBalanceCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _RoninBalance.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_RoninBalance *RoninBalanceTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _RoninBalance.Contract.contract.Transfer(opts)
}
...
func (_RoninBalance *RoninBalanceTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _RoninBalance.Contract.contract.Transact(opts, method, params...)
}
...
func (_RoninBalance *RoninBalanceCaller) BalanceOf(opts *bind.CallOpts, arg0 common.Address) (*big.Int, error) {
	var out []interface{}
	err := _RoninBalance.contract.Call(opts, &out, "balanceOf", arg0)
...
func (_RoninBalance *RoninBalanceSession) BalanceOf(arg0 common.Address) (*big.Int, error) {
	return _RoninBalance.Contract.BalanceOf(&_RoninBalance.CallOpts, arg0)
}
